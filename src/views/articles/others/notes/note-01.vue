<template>
    <BoWen>
        <div class="px-1" style="background: rgb(35, 36, 31)">
            ...
            <h3><Icon type="logo-buffer" /> JavaScript  offsetTop、offsetLeft、offsetWidth、offsetHeight</h3>
            <Divider />
            ...
            <h4 class="pt-1">注意：</h4>
            <p class="text-warn"><code>offsetTop</code> 和 <code>offsetParent</code> 都是一个只读属性。</p>
            ...
            <h3><Icon type="logo-buffer" /> JavaScript  scrollTop、scrollLeft、scrollWidth、scrollHeight</h3>
            <Divider />
            ...
            <h3><Icon type="logo-buffer" /> JavaScript  clientTop、clientLeft、clientWidth、clientHeight</h3>
            <Divider />
            ...
            <h3><Icon type="logo-buffer" /> 常见的使用方式</h3>
            <Divider />
            <pre v-highlight>
