<template>
    <div class="app-container">
        <Menu mode="horizontal" active-name="main">
            ...
            <Submenu class="float-right text-white" name="article">
                <template slot="title">
        ...
        <div class="bottom">
            Created in 1994 <span class="border-right"></span>网站开发者： <a class="text-white" href="">董万宏</a>
        </div>
    </div>
</template>
...
.app-container {
    ...
    width: 100%;
    height: 100%;
    background-image: url('./assets/images/main-bg-img-0.jpeg');
